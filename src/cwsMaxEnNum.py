...
def get_event(tag_file_path, event_file_path):
    ...
    #    + 'T-1='+contents[(i-1)*3+2] +'T-2=b'
        + 'Num=' + num
        + '\r')



    index = range(2,words_len-1)
    num = '0'
    for i in index:
      if (isNum(contents[i*3])): num = '1'
      event_list.append(
          ...
          + 'C-1='+contents[(i-1)*3]+'C0='+contents[i*3] + ' ' + 'C0='+contents[i*3]+'C1='+contents[(i+1)*3] + ' '
          + 'C-1='+contents[(i-1)*3]+'C1='+contents[(i+1)*3] + ' '
    #      + 'T-1='+contents[(i-1)*3+2] +'T-2='+contents[(i-2)*3+2]
          + 'Num=' + num
          + '\r')
      num = '0'

    
    if (isNum(contents[(words_len-1)*3])): num = '1'
    event_list.append(
...
def get_feature(test_file_path, feature_file_path):
    ...
    for line in contents_list:
      ...
      num = '0'
      if (isNum(line[(words_len-1)])): num = '1'
      feature_list.append(
